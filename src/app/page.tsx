            ...
            <form onSubmit={handleRequest} className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full border border-slate-200 p-3 rounded-lg mt-1 outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm" 
              ...
              <button 
                type="submit" 
                className="w-full bg-blue-600 text-white font-bold py-3.5 rounded-lg hover:bg-blue-700 transition-all shadow-lg shadow-blue-100"
              >
                Submit Application
              </button>
            </form>
